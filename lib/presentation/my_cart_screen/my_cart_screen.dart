  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: CustomAppBar(
          ...
          title: AppbarTitle(
              text: "lbl_my_cart".tr, margin: EdgeInsets.only(left: 6.h))),
      body: ListView(
          ...
          children: [
            Obx(() => ListView.separated(
                ...
                itemCount: controller
                    .myCartModelObj.value.productdetailsItemList.value.length,
                itemBuilder: (context, index) {
                  ProductdetailsItemModel model = controller
                      .myCartModelObj.value.productdetailsItemList.value[index];
            ...
            Text("msg_price_details_3".tr, style: theme.textTheme.bodyLarge),
            ...
            Divider(),
            SizedBox(height: 5.v),
            Text("msg_total_price2".tr, style: theme.textTheme.bodyLarge),
