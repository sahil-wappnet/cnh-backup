      ...
      body: Padding(
          ...
          child: Obx(() => ListView.separated(
              ...
              itemCount: controller
                  .medicineOrdersModelObj.value.userorderItemList.value.length,
              itemBuilder: (context, index) {
                UserorderItemModel model = controller.medicineOrdersModelObj
                    .value.userorderItemList.value[index];
