            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  Container(
                    padding:
                        EdgeInsets.symmetric(horizontal: 34.h, vertical: 23.v),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                            ...
                            child: Row(children: [
                              ...
                              Padding(
                                  ...
                                  child: Text("lbl_tue".tr.toUpperCase(),
                                      style: theme.textTheme.labelMedium)),
                              Padding(
                                  padding: EdgeInsets.only(left: 16.h),
                                  child: Text("lbl_wed".tr.toUpperCase(),
                                      style: theme.textTheme.labelMedium)),
                              Padding(
                                  padding: EdgeInsets.only(left: 16.h),
                                  child: Text("lbl_thu".tr.toUpperCase(),
                                      style: theme.textTheme.labelMedium)),
                              Padding(
                                  padding: EdgeInsets.only(left: 21.h),
                                  child: Text("lbl_fri".tr.toUpperCase(),
                                      style: theme.textTheme.labelMedium)),
                              Padding(
                                  padding: EdgeInsets.only(left: 22.h),
                                  child: Text("lbl_sat".tr.toUpperCase(),
                                      style: theme.textTheme.labelMedium)),
                              Padding(
                                  padding: EdgeInsets.only(left: 18.h),
                                  child: Text("lbl_sun".tr.toUpperCase(),
                                      style: theme.textTheme.labelMedium))
                            ])),
                        Align(
                                    ...
                                    children: [
                                      Padding(
                                          padding: EdgeInsets.symmetric(
                                              vertical: 3.v),
                                          child: Text("lbl_1".tr.toUpperCase(),
                                              style:
                                      ...
                                      Padding(
                                          padding: EdgeInsets.only(
                                              ...
                                              top: 3.v,
                                              bottom: 3.v),
                                          child: Text("lbl_2".tr.toUpperCase(),
                                              style:
                                                  theme.textTheme.titleSmall)),
                                      Padding(
                                          padding: EdgeInsets.only(
                                              ...
                                              top: 3.v,
                                              bottom: 3.v),
                                          child: Text("lbl_3".tr.toUpperCase(),
                                              style:
                                                  theme.textTheme.titleSmall)),
                                      Padding(
                                          padding: EdgeInsets.only(
                                              ...
                                              top: 3.v,
                                              bottom: 3.v),
                                          child: Text("lbl_4".tr.toUpperCase(),
                                              style:
                                                  theme.textTheme.titleSmall)),
                                      Container(
                                          ...
                                          decoration: AppDecoration.fillPrimary
                                              .copyWith(
                                                  borderRadius:
                                                      BorderRadiusStyle
                                                          .circleBorder12),
                                          child: Text("lbl_5".tr.toUpperCase(),
                                      ...
                                      Padding(
                                          padding: EdgeInsets.only(
                                              ...
                                              top: 3.v,
                                              bottom: 3.v),
                                          child: Text("lbl_6".tr.toUpperCase(),
                                              style:
                                                  theme.textTheme.titleSmall)),
                                      Padding(
                                          padding: EdgeInsets.only(
                                              ...
                                              top: 3.v,
                                              bottom: 3.v),
                                          child: Text("lbl_7".tr.toUpperCase(),
                                              style:
                                                  theme.textTheme.titleSmall))
                                    ]))),
                        Padding(
                            ...
                            child: Row(children: [
                              ...
                              Padding(
                                  ...
                                  child: Text("lbl_9".tr.toUpperCase(),
                                      style: theme.textTheme.titleSmall)),
                              Padding(
                                  padding: EdgeInsets.only(left: 26.h),
                                  child: Text("lbl_10".tr.toUpperCase(),
                                      style: theme.textTheme.titleSmall)),
                              Padding(
                                  padding: EdgeInsets.only(left: 24.h),
                                  child: Text("lbl_11".tr.toUpperCase(),
                                      style: theme.textTheme.titleSmall)),
                              Padding(
                                  padding: EdgeInsets.only(left: 26.h),
                                  child: Text("lbl_12".tr.toUpperCase(),
                                      style: theme.textTheme.titleSmall)),
                              Padding(
                                  padding: EdgeInsets.only(left: 24.h),
                                  child: Text("lbl_13".tr.toUpperCase(),
                                      style: theme.textTheme.titleSmall)),
                              Padding(
                                  padding: EdgeInsets.only(left: 23.h),
                                  child: Text("lbl_14".tr.toUpperCase(),
                                      style: theme.textTheme.titleSmall))
                            ])),
                        Padding(
                            padding: EdgeInsets.only(
                        ...
                        Padding(
                          padding:
                              EdgeInsets.only(left: 3.h, top: 22.v, right: 3.h),
                          child: Row(
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Padding(
                                padding: EdgeInsets.only(left: 21.h),
                                child: Text("lbl_30".tr.toUpperCase(),
                                    style: theme.textTheme.titleSmall),
                              ),
                              Padding(
                                padding: EdgeInsets.only(left: 22.h),
                                child: Text("lbl_31".tr.toUpperCase(),
                                    style: theme.textTheme.titleSmall),
                              ),
                            ],
                          ),
