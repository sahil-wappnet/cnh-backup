                ...
                Expanded(
                    child: SingleChildScrollView(
                      padding: EdgeInsets.only(
                                left: 10.h, right: 10.h, bottom: 5.v),
                        child: Column(
                                                              ...
                                                              children: [
                                                                Align(
                                                                    ...
                                                                    child: SizedBox(
                                                                        ...
                                                                        child: Stack(alignment: Alignment.center, children: [
                                                                          CustomImageView(imagePath: ImageConstant.imgEllipse182, height: 34.adaptSize, width: 34.adaptSize, radius: BorderRadius.circular(17.h), alignment: Alignment.topLeft, margin: EdgeInsets.only(left: 4.h)),
                                                                          Align(
                                                                              alignment: Alignment.center,
                                                                ...
                                                                Align(
                                                                    ...
                                                                    child: Padding(
                                                                        ...
                                                                        child: SizedBox(width: 232.h, child: Divider())))
                                                              ])))
                                                ]))))
                              ])
                            ]))),
