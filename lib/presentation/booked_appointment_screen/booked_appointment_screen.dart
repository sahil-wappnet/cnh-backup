          ...
          child: SingleChildScrollView(
            child:
              ...
              Row(children: [
                ...
                Padding(
                    padding: EdgeInsets.only(left: 10.h, top: 9.v, bottom: 9.v),
                    child: Column(
                ...
                CustomImageView(
                    ...
                    width: 20.adaptSize,
                    margin:
                        EdgeInsets.only(left: 24.h, top: 20.v, bottom: 20.v))
              ]),
              Align(
                  alignment: Alignment.center,
                  child: Container(
                      margin:
                          EdgeInsets.only(left: 14.h, top: 18.v, right: 14.h),
                      padding:
                      ...
                      child: Row(
                          ...
                          children: [
                            ...
                            Padding(
                                padding:
                                    EdgeInsets.fromLTRB(10.h, 3.v, 1.h, 4.v),
                                child: Text("lbl_5_oct_2023".tr,
                                    style:
                                        CustomTextStyles.bodyMediumWhiteA700_1))
                          ]))),
              SizedBox(height: 36.v),
              Text("lbl_upload_reports".tr, style: theme.textTheme.bodyLarge),
              ...
              Container(
                  ...
                  padding:
                      EdgeInsets.symmetric(horizontal: 143.h, vertical: 23.v),
                  ...
                  child: Column(
                      ...
                      children: [
                        CustomImageView(
                            ...
                            width: 24.adaptSize),
                        SizedBox(height: 7.v),
                        Text("lbl_upload".tr, style: theme.textTheme.bodySmall)
                      ])),
